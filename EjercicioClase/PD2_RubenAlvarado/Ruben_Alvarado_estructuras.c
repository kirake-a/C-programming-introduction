...
se declara la estructura fuera de main para que sea una estructura global*/
struct hospital{
    char nombre[20];
    char direccion[20];
    int edad;
...
int main(){
    ...
    /* Se llama a la funcion desde main que realiza todos los procesos de pedida de datos
